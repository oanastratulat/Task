 ...
 * $Id: f3f8b994cfbc317d812be786bec5e3c6b733dc0c $
 *
...
Qt::ItemFlags MLDirModel::flags( const QModelIndex &index ) cons
{
...
QVariant MLDirModel::data( const QModelIndex &index, int role ) cons
{
...
int MLDirModel::columnCount( const QModelIndex & ) cons
{
  return 1;
}
