...
MLItem* MLItem::child( int row ) cons
{
...
int MLItem::rowOfChild( MLItem *item ) cons
{
  return children.indexOf( item );
}

int MLItem::childCount() cons
{
  return children.count();
}

MLItem* MLItem::parent() cons
{
  return parentItem;
}
 ...
 */
QVariant MLItem::data( int column ) cons
{
...
ml_media_t* MLItem::getMedia() cons
{
  return media;
}

QUrl MLItem::getUri() cons
{
