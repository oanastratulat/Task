 ...
 * $Id: bb643821c91f72c33043a141ac0cb78fe37e63ef $
 *
...
void PLSelector::setSource( QTreeWidgetItem *item )
{
  ...
  if( i_type == SD_TYPE )
  {
    ...
    pl_item = NULL; //to prevent activating i
    }
  }
  else
...
QStringList PLSelector::mimeTypes() cons
{
  QStringList types;
...
void PLSelector::drawBranches ( QPainter * painter, const QRect & rect, const QModelIndex & index ) cons
{
