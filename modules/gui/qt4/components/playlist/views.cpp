/*****************************************************************************
 * views.cpp : Views for the Playlis
 ****************************************************************************
...
void AbstractPlViewItemDelegate::paintBackground(
  QPainter *painter, const QStyleOptionViewItem & option, const QModelIndex & index ) cons
{
...
void PlIconViewItemDelegate::paint( QPainter * painter, const QStyleOptionViewItem & option, const QModelIndex & index ) cons
{
...
QSize PlIconViewItemDelegate::sizeHint ( const QStyleOptionViewItem &, const QModelIndex & index ) cons
{
...
void PlListViewItemDelegate::paint( QPainter * painter, const QStyleOptionViewItem & option, const QModelIndex & index ) cons
{
  QString title = VLCModel::getMeta( index, COLUMN_TITLE );
...
QSize PlListViewItemDelegate::sizeHint ( const QStyleOptionViewItem &, const QModelIndex & ) cons
{
  QFont f;
  f.setBold( true );
  QFontMetrics fm( f );
...
int PicFlowView::horizontalOffset() cons
{
  return 0;
}

int PicFlowView::verticalOffset() cons
{
  return 0;
}

QRect PicFlowView::visualRect(const QModelIndex & ) cons
{
...
QModelIndex PicFlowView::indexAt(const QPoint &) cons
{
  return QModelIndex();
...
bool PicFlowView::isIndexHidden(const QModelIndex &index) cons
{
  int currentIndex = picFlow->centerIndex();
...
QRegion PicFlowView::visualRegionForSelection(const QItemSelection &) cons
{
  return QRect();
}
