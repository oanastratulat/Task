 ...
 *
 * $Id: 138bceaa8c6f3a34c54fe45a697d034253fe8b45 $
 *
...
inline void FileOpenPanel::BuildOldPanel()
{
  ...
  // Add the DialogBox to the layou
...
QValidator::State UrlValidator::validate( QString& str, int& ) cons
{
  if( str.contains( ' ' ) )
...
void UrlValidator::fixup( QString& str ) cons
{
  str = str.trimmed();
}
...
/**
 * Update the Buttons (show/hide) for the GUI as all device type don'
