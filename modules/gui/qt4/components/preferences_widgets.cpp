 ...
 * $Id: 9c9ddd4d7b9c4dcbe4ed1f0b77b177fa4cfc3bac $
 *
...
QString StringListConfigControl::getValue() cons
{
...
QString ModuleConfigControl::getValue() cons
{
  return combo->itemData( combo->currentIndex() ).toString();
}
...
QString ModuleListConfigControl::getValue() cons
{
  assert( text );
  return text->text();
}
...
int IntegerConfigControl::getValue() cons
{
  return spin->value();
}
...
int IntegerRangeSliderConfigControl::getValue() cons
{
    return slider->value();
}
...
int IntegerListConfigControl::getValue() cons
{
...
int BoolConfigControl::getValue() cons
{
...
int ColorConfigControl::getValue() cons
{
  return i_color;
}
...
float FloatConfigControl::getValue() cons
{
