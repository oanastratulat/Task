 ...
 * $Id: 849c7cdde57183d54c353a557c30e151fbe0e8f2 $
 *
...
/**
 * Update all the MetaData and art on an "item-changed" even
 **/
...
void MetaPanel::saveMeta()
{
  ...
  /* Reset the status of the mode. No need to emit any signal because paren
   is the only caller */
  b_inEditMode = false;
}
