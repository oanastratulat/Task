 ...
 * $Id: 2a3a8f1c1ed5c3016f231623d96fac783742819f $
 *
...
#include "util/customwidgets.hpp"     // qtEventToVLCKey, QVLCStackedWidge
#include "util/qt_dirs.hpp"       // toNativeSeparators

#include "components/interface_widgets.hpp"   // bgWidget, videoWidge
#include "components/controller.hpp"    // controllers
#include "components/playlist/playlist.hpp"   // plWidge
...
void MainInterface::setName( const QString& name )
{
  ...
  /* Display it in the status bar, but also as a Tooltip in case it doesn'
   fit in the label */
...
void MainInterface::dropEventPlay( QDropEvent *event, bool b_play )
{
  ...
  /* Browsers give content as text if you dnd the addressbar,
   so check if mimedata has valid url in text and use i
