 ...
 * $Id: b236a61fe30bfd625ecfa1633b91c9c4cbab6c37 $
 *
...
QSize DeckButtonsLayout::sizeHint() cons
{
...
int DeckButtonsLayout::count() cons
{
  return 3;
}
...
QLayoutItem* DeckButtonsLayout::itemAt( int index ) cons
{
  switch ( index ) {
    case 0:
    return backwardItem;
