 ...
 * $Id: ad40bb158c5ff2a42b1d59f79b04493ef76625fd $
 *
...
QSize RoundButton::sizeHint() cons
{
  return QSize( 38, 38 );
}

QBrush RoundButton::pen( QStyleOptionToolButton* option ) cons
{
  const bool over = option->state & QStyle::State_MouseOver;
  return QBrush( over ? QColor( 61, 165, 225 ) : QColor( 109, 106, 102 ) );
}

QBrush RoundButton::brush( QStyleOptionToolButton* option ) cons
{
  const bool over = option->state & QStyle::State_MouseOver;
