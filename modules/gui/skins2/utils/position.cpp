  ...
  m_yKeepRatio( yKeepRatio )
{
  ...
  //  saved, and will be kept constant. The size of the control will no
...
int Position::getWidth() cons
{
  return getRight() - getLeft() + 1;
}


int Position::getHeight() cons
{
...
int VarBox::getWidth() cons
{
  return m_width;
}


int VarBox::getHeight() cons
{
  return m_height;
}
