...
bool Win32Window::invalidateRect( int x, int y, int w, int h) cons
{
...
void Win32Window::hide() cons
{
  ShowWindow( m_hWnd, SW_HIDE );
}


void Win32Window::moveResize( int left, int top, int width, int height ) cons
{
  MoveWindow( m_hWnd, left, top, width, height, TRUE );
}


void Win32Window::raise() cons
{
...
void Win32Window::setOpacity( uint8_t value ) cons
{
  if( !m_isLayered )
  {
...
void Win32Window::toggleOnTop( bool onTop ) cons
{
