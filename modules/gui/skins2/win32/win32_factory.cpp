...
int Win32Factory::getScreenWidth() cons
{
  return GetSystemMetrics(SM_CXSCREEN);
}


int Win32Factory::getScreenHeight() cons
{
...
SkinsRect Win32Factory::getWorkArea() cons
{
  RECT r;
...
void Win32Factory::getMousePos( int &rXPos, int &rYPos ) cons
{
  POINT mousePos;
...
void Win32Factory::changeCursor( CursorType_t type ) cons
{
  LPCTSTR id;
  switch( type )
  {
...
void Win32Factory::rmDir( const string &rPath )
{
  ...
  while( handle != INVALID_HANDLE_VALUE )
  {
    ...
    // Else, it is a file so simply delete i
    else
    {
