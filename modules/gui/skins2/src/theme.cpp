 ...
 * $Id: 68b426b159bead11b43cae0434a7eb683188f2cf $
 *
...
int Theme::readConfig()
{
  ...
  while( !inStream.eof() )
  {
    ...
    // Try to find the window and the layou
...
// Takes an ID of the form "id1;id2;id3", and returns the objec
...
Theme::IDmap<T>::find_first_object( const string &id ) cons
{
  string rightPart = id;
...
GenericBitmap *Theme::getBitmapById( const string &id ) cons
{
  return m_bitmaps.find_first_object( id );
}

GenericFont *Theme::getFontById( const string &id ) cons
{
