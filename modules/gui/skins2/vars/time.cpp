...
string StreamTime::getAsStringPercent() cons
{
...
string StreamTime::formatTime( int seconds, bool bShortFormat ) cons
{
...
string StreamTime::getAsStringCurrTime( bool bShortFormat ) cons
{
  if( !havePosition() )
    return "-:--:--";
...
string StreamTime::getAsStringTimeLeft( bool bShortFormat ) cons
{
  if( !havePosition() )
    return "-:--:--";
...
string StreamTime::getAsStringDuration( bool bShortFormat ) cons
{
  if( !havePosition() )
    return "-:--:--";
