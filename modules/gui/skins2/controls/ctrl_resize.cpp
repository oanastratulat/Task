...
bool CtrlResize::mouseOver( int x, int y ) cons
{
...
const Position *CtrlResize::getPosition() cons
{
...
void CtrlResize::changeCursor( WindowManager::Direction_t direction ) cons
{
