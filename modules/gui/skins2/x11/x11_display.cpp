...
template<class type> type X11Display::putPixel(type r, type g, type b) cons
{
...
template<class type>
type X11Display::blendPixel(type v,type r, type g, type b, type a) cons
{
  uint16_t temp;
