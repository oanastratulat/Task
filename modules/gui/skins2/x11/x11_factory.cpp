...
int X11Factory::getScreenWidth() cons
{
  return m_screenWidth;
}


int X11Factory::getScreenHeight() cons
{
...
void X11Factory::getDefaultGeometry( int* p_width, int* p_height ) cons
{
  Display *pDisplay = m_pDisplay->getDisplay();
...
SkinsRect X11Factory::getWorkArea() cons
{
  // XXX
...
void X11Factory::getMousePos( int &rXPos, int &rYPos ) cons
{
