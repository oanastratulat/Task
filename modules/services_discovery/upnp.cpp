...
static int Open( vlc_object_t *p_this )
{
  ...
  /* Initialize on first IPv4-capable adapter and first open por
...
const char* MediaServer::getUDN() cons
{
  return _UDN.c_str();
}

const char* MediaServer::getFriendlyName() cons
{
...
const char* MediaServer::getContentDirectoryEventURL() cons
{
...
const char* MediaServer::getContentDirectoryControlURL() cons
{
...
input_item_t* MediaServer::getInputItem() cons
{
...
const char* Item::getObjectID() cons
{
  return _objectID.c_str();
}

const char* Item::getTitle() cons
{
  return _title.c_str();
}

const char* Item::getResource() cons
{
  return _resource.c_str();
}

mtime_t Item::getDuration() cons
{
  return _duration;
}
...
const char* Container::getObjectID() cons
{
  return _objectID.c_str();
}

const char* Container::getTitle() cons
{
  return _title.c_str();
}

unsigned int Container::getNumItems() cons
{
  return _items.size();
}

unsigned int Container::getNumContainers() cons
{
  return _containers.size();
}

Item* Container::getItem( unsigned int i_index ) cons
{
  if ( i_index < _items.size() ) return _items[i_index];
  return 0;
}

Container* Container::getContainer( unsigned int i_index ) cons
{
...
input_item_t* Container::getInputItem() cons
{
  return _p_input_item;
}
