 ...
 * Atmo Light, opens and configures the serial por
 *
...
#if defined(WIN32)
   WriteFile(m_hComport, sendBuffer, 13, &iBytesWritten, NULL); // send to COM-Por
#else
...
#if defined(WIN32)
 WriteFile(m_hComport, buffer, 19, &iBytesWritten, NULL); // send to COM-Por
#else
