 ...
 * @param p_aout: audio output objec
 * @param p_filter: filter objec
...
/**
 * Variable callback for the dummy vou
 */
 ...
 * @param p_this: the p_thread objec
 */
