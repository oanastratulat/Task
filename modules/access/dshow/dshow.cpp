 ...
 * $Id: 9405af20b81b085648fd3863fa7d3ea0002410c2 $
 *
            ...
            if(( !pVSCC->OutputGranularityY
             ...
             ( pVSCC->OutputGranularityY
               && ((i_height % pVSCC->OutputGranularityY)
                 || pVSCC->MinOutputSize.cy > i_heigh
                 || i_height > pVSCC->MaxOutputSize.cy )))
            {
