...
/* VCD Player header. More or less media-player independent. Or at leas
...
typedef struct vcdplayer_input_s
{
 ...
 --------------------------------------------------------------*/
  ...
  PsdListDescriptor_t pxd;      /* If PBC is on, the relevan
                PSD/PLD */
 ...
 ------------------------------------*/
  ...
  lsn_t    end_lsn;       /* LSN of end of curren
 ...
 ---------------------------------------------------------------*/
  ...
  track_t  i_tracks;      /* # of playable MPEG tracks. This is
               ...
               is an ISO-9660 track and is no
               playable.
              */
