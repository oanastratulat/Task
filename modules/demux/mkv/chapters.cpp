...
std::string chapter_item_c::GetCodecName( bool f_for_title ) cons
{
  std::string result;
...
int16 chapter_item_c::GetTitleNumber( ) cons
{
  int result = -1;
...
bool chapter_item_c::ParentOf( const chapter_item_c & item ) cons
{
  if ( &item == this )
    return true;
...
std::string chapter_edition_c::GetMainName() cons
{
