 ...
 * $Id: b80f492814619452f63b932f92833bee77dd65c5 $
 *
 ...
 *  * LoadTags : load ... the tags elemen
 *  * InformationCreate : create all information, load tags if presen
 *****************************************************************************/
...
bool matroska_segment_c::Select( mtime_t i_start_time )
{
   ...
   * either by an earlier 'default track' (??) or by defaul
