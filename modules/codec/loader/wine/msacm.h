...
typedef WIN_BOOL CALLBACK ( *ACMDRIVERENUMCB)(
  HACMDRIVERID hadid, DWORD dwInstance, DWORD fdwSuppor
);

typedef WIN_BOOL16 CALLBACK ( *ACMDRIVERENUMCB16)(
  HACMDRIVERID16 hadid, DWORD dwInstance, DWORD fdwSuppor
);
...
typedef WIN_BOOL CALLBACK ( *ACMFILTERENUMCBA)(
  ...
  DWORD dwInstance, DWORD fdwSuppor
);
...
MMRESULT16 WINAPI acmFormatSuggest16(
  ...
  LPWAVEFORMATEX pwfxDst, DWORD cbwfxDst, DWORD fdwSugges
);
...
MMRESULT16 WINAPI acmStreamConvert16(
  HACMSTREAM16 has, LPACMSTREAMHEADER16 pash, DWORD fdwConver
);
MMRESULT16 WINAPI acmStreamReset16(
  HACMSTREAM16 has, DWORD fdwRese
);
...
MMRESULT WINAPI acmFormatSuggest(
  ...
  DWORD cbwfxDst, DWORD fdwSugges
);
...
MMRESULT WINAPI acmStreamConvert(
  HACMSTREAM has, PACMSTREAMHEADER pash, DWORD fdwConver
);
