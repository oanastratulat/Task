...
# define WINELIB_NAME_AW(func) \
  ...
  func##_must_be_suffixed_with_W_or_A_in_this_contex
#else  /* __WINE__ */
# ifdef UNICODE
...
/* FIXME: Wine does not compile with strict on, therefore stric
 * handles are presently only usable on machines where sizeof(UINT) ==
 * sizeof(void*).  HANDLEs are supposed to be void* but a large amoun
...
/* Note: These macros are semantically broken, at least for wrc.  wrc
 ...
 macros have simply been disabled.  In the future, someone may wan
