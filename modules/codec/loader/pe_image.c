 ...
 *	- use the ordinal as offset into the functionlis
 * If it is a ordinal:
 *	- use ordinal-pe_export->Base as offset into the functionlis
 */
...
//  CloseHandle( mapping );
   ...
   *   shared address space > 2GB.  In this case, we assume tha
 ...
 * FIXME: this function should use PE_LoadLibraryExA, but currently can'
