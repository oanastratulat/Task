 ...
 * $Id: 500973fa2a6634c6e3454d664035e55689d66a02 $
 *
...
#undef V
   ...
   */
    ...
    return;
    if( i_src < 5 + 1+1 + i_count_cc*3 + 1)  // broken packe
    return;
    if( i_count_cc <= 0 ) // no cc presen
    return;
    if( cc[2+i_count_cc * 3] != 0xff )  // marker absen
    return;
    cc += 2;
