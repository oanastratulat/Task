...
enum enc_events
{
  ...
  ENC_START_FILE = 0,  /* a new file has been opened and no data has ye
          been written             */
  ...
  ENC_REC_NEW_STREAM,  /* Take steps to finish current stream and star
          new                */
};
...
/**
 * encoder may add some data to the end of the last and start of the nex
